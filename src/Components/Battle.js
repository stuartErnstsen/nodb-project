            ...
            <section id="battle-container">
                ...
                <footer id="battle-footer">
                    ...
                    ? (
                        ...
                        ? <div id="results-button" className="battle-button" onClick={this.addResults}>NEXT<br/>FIGHT!</div>
                        : <div id="fight-button" className="battle-button" onClick={this.fight}>FIGHT!</div>
                    ) : (
                        <svg onClick={this.createBattlePair} xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-plus-circle" viewBox="0 0 16 16">
